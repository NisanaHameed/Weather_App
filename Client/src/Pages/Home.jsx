...
import { forecast, historical } from '../API/userApi';
...
const Home = () => {
    ...
    return (
        <div className='min-h-screen bg-cover bg-center p-7' style={{ backgroundImage: `url('/sky.jpg')` }}>
            <div className='flex justify-end mb-4'>
            <button type="button" class="text-white bg-gradient-to-r from-cyan-400 via-cyan-500 to-cyan-600 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-cyan-300 shadow-lg shadow-cyan-500/50 dark:shadow-lg font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Favorites</button>
            <button type="button" className="text-white bg-gradient-to-r from-cyan-500 to-blue-500 hover:bg-gradient-to-bl focus:ring-4 focus:outline-none focus:ring-cyan-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center me-2 mb-2">Log Out</button>
            </div>
            ...
            <div className='mt-4'>
                ...
                <div className='flex items-center justify-center w-full mt-2 overflow-x-auto overflow-y-hidden whitespace-nowrap hide-scrollbar'>
                    {weatherData?.map((val, index) => (
                        <div key={index} className='inline-block py-4 flex-shrink-0 w-32 mt-2 bg-[#27649e] hover:bg-[#205688] rounded-lg mr-3'>
                            ...
                            <h2 className="text-gray-400 text-center text-sm mt-2">{val?.weather?.description}</h2>
                        </div>
                    ))}
                </div>
            </div>
